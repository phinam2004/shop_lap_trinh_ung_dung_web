...
public static class PartnerDataService
{
    ...
    {
        if (string.IsNullOrWhiteSpace(data.CustomerName) || string.IsNullOrWhiteSpace(data.Email) || string.IsNullOrWhiteSpace(data.Province))
            return 0;
    ...
    /// <returns></returns>
    public static async Task<bool> UpdateCustomerPasswordAsync(int customerID, string newPassword)
    {
        return await customerDB.UpdatePasswordAsync(customerID, newPassword);
    }
